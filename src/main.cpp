...
const string strMessageMagic = "SYB Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int64_t nMoneySupply)
{
    ...
    int64_t nSubsidy = 0;
    int64_t nInitialMoney = 1000000000;
...
{
    int64_t nSubsidy = (nMoneySupply * 0.01) / 525600;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SYB", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
unsigned char pchMessageStart[4] = { 0x2a, 0x1e, 0xb3, 0xd5 };
